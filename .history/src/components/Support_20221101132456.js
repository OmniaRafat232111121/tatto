...
const Support = () => {
  ...
  <div className='grid grid-cols-3 relative w-full  py-10 h-40 sm:px-10 sm:py-20' >
      <div className='bg-white shadow-lg text-2xl hover:scale-110 duration-200 sm:px-10 sm:py-20'>
