...
const Support = () => {
  return (
    <div  name="support" className='w-full mt-[40px] ' >
      ...
      <div className=' max-w-[1240px]  <div className='max-w-[1240px] mx-auto text-white relative'> text-black mx-auto relative'>
  ...
  <div className='grid  grid-cols-1 lg:grid-cols-3 relative w-full  py-10 h-40 sm:px-10 sm:py-20 ' >
      <div className='bg-white shadow-lg text-2xl hover:scale-110 duration-200 sm:p-[10px] '>
