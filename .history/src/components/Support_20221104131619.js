...
const Support = () => {
  return (
    <div  name="support" className='w-full mt-[40px] ' >
      ...
      <h2 className='text-3xl pt-8 text-white uppercase text-center'>Support</h2>
      <h3 className='text-5xl font-bold py-6 text-white text-center'>Finding the right team</h3>
      <p className='py-4 text-3xl text-white '>Lorem ipsum dolor sit amet consectetur adipisicing elit. In repudiandae veritatis ratione error tenetur, voluptates architecto possimus ad! Omnis minima ea quidem quisquam unde beatae, minus illo et cum vel?</p>
