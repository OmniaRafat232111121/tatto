...
useEffect(()=>{
  ...
  return (
    <header
      className={`${
        isActive ? 'h-[100px] lg:h-[110px] md:h-[90px] shadow-lg bg-black text-gray-50' : 'h-[120px] lg:h-[150px]'
    ...
    >
      <div className='flex justify-between items-center h-full pl-[50px] pr-[60px]'>
        ...
        <div className='hidden xl:flex'>
         ...
         className='xl:hidden absolute right bg-dark p-2 rounded-md cursor-pointer'
         
       >
         <TiThMenuOutline className='text-3xl text-white bg-green-800' />
       </div>
