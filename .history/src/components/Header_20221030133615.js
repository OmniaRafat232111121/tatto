...
useEffect(()=>{
  ...
  return (
    <header
      className={`${
        isActive ? 'h-[100px] lg:h-[110px] bg-black text-gray-300':'h-[120px] lg:h-[150px] '
      }  bg-white fixed left-0 right-0 z-10 max-w-full w-full mx-auto transition-all duration-300`}
      >
      <div className='flex justify-betwe items-center h-full pl-[50px] pr-[60px]'>
        {/* logo */}
        <a href='/'>
