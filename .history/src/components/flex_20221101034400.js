...
const Flex = () => {
  return (
    <div className=' h-full bg-black text-white border-white py-[30rem] w-full px-[30px]'>
    <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 bg-white text-bl'>
