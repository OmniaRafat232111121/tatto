...
const Flex = () => {
  return (
    ...
    <h2 className='text-2xl font-bold text-center py-8'>Two tatto</h2>
          ...
          <button className='bg-[#020303]  text-whitew-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
    </div>
    <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
    <h2 className='text-2xl font-bold text-center py-8'>Three tatto</h2>
          ...
          <button className='bg-[#020303] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
    </div>
    </div>
    </div>
  )
